version = 'v6.0' # Added functionality to colour map centre and sides seperately
...
def start():
	...
	if pltvar.get() == 'None': # If centre colour map == 'None'
		bkg.paste(origimg, box=(math.ceil((wid/2)-(img.size[0]/2)), 0)) # Paste original image in the center of new image
	else:
...
plttext = Label(pltframe, text='Centre', bg='#5a49a4', fg='#d7ceff', activebackground='#5a49a4', activeforeground='#d7ceff', padx=10) # Dropdown label
...
plttext2 = Label(pltframe, text='Sides', bg='#5a49a4', fg='#d7ceff', activebackground='#5a49a4', activeforeground='#d7ceff', padx=10) # Dropdown label
