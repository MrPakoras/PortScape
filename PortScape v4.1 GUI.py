# v4.1 - Creating preview window and improving efficiency
...
startbutton = Button(leftsubframe, text='Create!', command=lambda:threading.Thread(target=start).start(), width=20, height=2, bg='#1d1c2c', fg='#8d73ff', activebackground='#1d1c2c' , activeforeground='#8d73ff')
# leftsubframe.rowconfigure(3, weight=1)
leftsubframe.rowconfigure(7, pad=10)
